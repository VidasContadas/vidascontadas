...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Noticia.comercio'
        db.delete_column(u'comercios_noticia', 'comercio_id')


    def backwards(self, orm):
        # Adding field 'Noticia.comercio'
        db.add_column(u'comercios_noticia', 'comercio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='noticias', to=orm['comercios.Comercio']),
                      keep_default=False)
