...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evento.direccion'
        db.alter_column(u'comercios_evento', 'direccion', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Evento.direccion'
        db.alter_column(u'comercios_evento', 'direccion', self.gf('django.db.models.fields.TextField')())
