...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'comercios_evento', 'fecha_fin', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Evento.hora_inicio'
        db.alter_column(u'comercios_evento', 'hora_inicio', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Evento.hora_fin'
        db.alter_column(u'comercios_evento', 'hora_fin', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Evento.fecha_fin'
        db.alter_column(u'comercios_evento', 'fecha_fin', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Evento.hora_inicio'
        db.alter_column(u'comercios_evento', 'hora_inicio', self.gf('django.db.models.fields.TimeField')(default=None))

        # Changing field 'Evento.hora_fin'
        db.alter_column(u'comercios_evento', 'hora_fin', self.gf('django.db.models.fields.TimeField')(default=None))
    ...
    models = {
        ...
        u'comercios.comercio': {
            ...
            'categorias': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'comercios'", 'symmetrical': 'False', 'to': u"orm['comercios.Categoria']"}),
        ...
        u'comercios.evento': {
            'Meta': {'ordering': "('-fecha_inicio', '-hora_inicio', 'titulo')", 'object_name': 'Evento'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_removed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'descripcion': ('django.db.models.fields.TextField', [], {}),
            'direccion': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'fecha_fin': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {}),
            'hora_fin': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'comercios.noticia': {
            'Meta': {'ordering': "('-fecha', 'titulo')", 'object_name': 'Noticia'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_removed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
