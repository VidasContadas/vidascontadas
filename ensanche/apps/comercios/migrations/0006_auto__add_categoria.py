...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'comercios_categoria')
    ...
    models = {
        ...
        u'comercios.comercio': {
            ...
            'categoria': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['comercios.Categoria']", 'symmetrical': 'False'}),
