...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field categoria on 'Comercio'
        db.delete_table(db.shorten_name(u'comercios_comercio_categoria'))

        # Adding M2M table for field categorias on 'Comercio'
        m2m_table_name = db.shorten_name(u'comercios_comercio_categorias')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comercio', models.ForeignKey(orm[u'comercios.comercio'], null=False)),
            ('categoria', models.ForeignKey(orm[u'comercios.categoria'], null=False))
        ))
        db.create_unique(m2m_table_name, ['comercio_id', 'categoria_id'])


    def backwards(self, orm):
        # Adding M2M table for field categoria on 'Comercio'
        m2m_table_name = db.shorten_name(u'comercios_comercio_categoria')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comercio', models.ForeignKey(orm[u'comercios.comercio'], null=False)),
            ('categoria', models.ForeignKey(orm[u'comercios.categoria'], null=False))
        ...
        # Removing M2M table for field categorias on 'Comercio'
        db.delete_table(db.shorten_name(u'comercios_comercio_categorias'))
    ...
    models = {
        ...
        u'comercios.comercio': {
            ...
            'categorias': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['comercios.Categoria']", 'symmetrical': 'False'}),
