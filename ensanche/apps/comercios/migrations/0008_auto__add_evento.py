...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Evento'
        db.create_table(u'comercios_evento', (
            ...
            ('hora_inicio', self.gf('django.db.models.fields.TimeField')(blank=True)),
            ('hora_fin', self.gf('django.db.models.fields.TimeField')(blank=True)),
        ))
        db.send_create_signal(u'comercios', ['Evento'])


    def backwards(self, orm):
        # Deleting model 'Evento'
        db.delete_table(u'comercios_evento')
    ...
    models = {
        ...
        u'comercios.evento': {
            ...
            'hora_fin': ('django.db.models.fields.TimeField', [], {'blank': 'True'}),
            'hora_inicio': ('django.db.models.fields.TimeField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']"}),
